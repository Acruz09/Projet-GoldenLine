...
class TestAnalysesView(TestCase):
    def setUp(self):
        ...
        collecte = Collecte.objects.create(identifiant_collecte=1, detail_panier={'categorie1': 10, 'categorie2': 20}, prix_panier=30)
        Client.objects.create(identifiant_client=1, nombre_enfants=5, categorie_socioprofessionnelle='categorie', identifiant_collecte=collecte)
    ...
    def test_analyses_view_avec_permission(self):
        ...
        self.assertIn('categorie_socioprofessionnelles', response.context)
...
class TestExportationDonneesView(TestCase):
    def setUp(self):
        ...
        collecte1 = Collecte.objects.create(identifiant_collecte=1, detail_panier={'categorie1': 10, 'categorie2': 20}, prix_panier=30)
        collecte2 = Collecte.objects.create(identifiant_collecte=2, detail_panier={'categorie1': 20, 'categorie2': 200}, prix_panier=220)
        collecte3 = Collecte.objects.create(identifiant_collecte=3, detail_panier={'categorie1': 40, 'categorie2': 25}, prix_panier=65)
        Client.objects.create(identifiant_client=1, nombre_enfants=5, categorie_socioprofessionnelle='categorie', identifiant_collecte=collecte1)
    ...
    def test_exporter_donnees_avec_permission(self):
        ...
        self.assertEqual(rows[0], ['identifiant_collecte;prix_panier;detail_panier'])
        self.assertEqual(rows[1], ["1;30.00;{'categorie1': 10", " 'categorie2': 20}"])
        self.assertEqual(rows[2], ["2;220.00;{'categorie1': 20", " 'categorie2': 200}"])
